...
test("uses stable release artifact names for baseline installation", () => {
	const stableArtifactPattern = /^MetoAI-0\.5\.46(?:-win-x64\.exe|-mac\.zip|-arm64-mac\.zip|\.AppImage)$/;
	for (const artifactName of [
		"MetoAI-0.5.46-win-x64.exe",
		"MetoAI-0.5.46-mac.zip",
		"MetoAI-0.5.46-arm64-mac.zip",
		"MetoAI-0.5.46.AppImage",
	]) {
